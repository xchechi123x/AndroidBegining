package com.xiaolaogong.test.custom.layout;

/**
 * Created by chechi on 2017/8/23.
 */
...
public class CoordinatorTabLayout extends CoordinatorLayout {
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.custom_coordinator_tab_layout, this, true);
    ...
    private void initWidget(Context context, AttributeSet attrs) {
        ...
        int contentScrimColor = typedArray.getColor(
                R.styleable.CoordinatorTabLayout_content_scrim, typedValue.data);

        mCollapsingToolbarLayout.setContentScrimColor(contentScrimColor);

        int tabIndicatorColor = typedArray.getColor(R.styleable.CoordinatorTabLayout_tab_indicator_color, Color.WHITE);

        mTabLayout.setSelectedTabIndicatorColor(tabIndicatorColor);

        int tabTextColor = typedArray.getColor(R.styleable.CoordinatorTabLayout_tab_text_color, Color.WHITE);
    ...
    public CoordinatorTabLayout setTransulcentStatusBar(@NonNull Activity activity) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            ...
            mToolbar.setPadding(0, Tools.getStatusBarHeight(activity) / 2, 0, 0);
        }
